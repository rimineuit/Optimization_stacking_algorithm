- Huấn luyện tinh chỉnh các mô hình học sâu tiên tiến như ResNet, VGG, Vision Transformer (ViT) và SWIN Transformer trên bộ dữ liệu Skin classification khác nhau.
